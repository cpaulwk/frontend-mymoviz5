...
function Home() {
  ...
  //         // console.log(data);
  //         movie.title = data.movies[i].original_title;
  //         movie.poster = `https://image.tmdb.org/t/p/w500/${data.movies[i].poster_path}`;
  //         movie.voteAverage = data.movies[i].vote_average;
  //         movie.voteCount = data.movies[i].vote_count;
  //         movie.overview = data.movies[i].overview.slice(0, 250) + "...";
  //         console.log(movie);
  //       });
